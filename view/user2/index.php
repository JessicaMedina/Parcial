        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                ...
                <ul class="nav navbar-right top-nav">
                    ...
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user"></i>  Usuario 2 <?php echo ucfirst($_SESSION['nombre']); ?> <b class="caret"></b></a>
...
<!--                            <a href="javascript:;" data-toggle="collapse" data-target="#demo"><i class="fa fa-fw fa-arrows-v"></i> Carta <i class="fa fa-fw fa-caret-down"></i></a>-->
                            ...
                            <a href="../../Funciones/agregarproducto.php"><i class="fa fa-fw fa-edit"></i> Agregar Producto</a>
                            <a href="../registro.php"> <i class="fa fa-fw fa-edit"></i> Agregar Usuario</a>
