        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                ...
                <ul class="nav navbar-right top-nav">
                    ...
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user"></i>  SUPER USUARIO  <?php echo ucfirst($_SESSION['nombre']); ?> <b class="caret"></b></a>
                    ...
                    <ul class="nav navbar-nav side-nav">
                        ...
                        <li>
                            ...
                            <ul id="demo" class="collapse">
                                <li>
                                    <a href="../../Funciones/ReporteFact.php">Facturación</a>
                                </li>
                                <li>
                                    <a href="../../Funciones/ReporteCaja.php">Caja</a>
                                </li>

                                <li>
                                    <a href="../../Funciones/ReporteCocina.php">Cocina</a>
                                </li>
                             </ul>
                            <a href="../../Plato/CatalogoPlatos.php"><i class="fa fa-fw fa-desktop"></i> Leer</a>
                            <a href="../../Funciones/agregarproducto.php"><i class="fa fa-fw fa-edit"></i> Crear</a>
                            <a href="../../Funciones/modificar.php"><i class="fa fa-fw fa-edit"></i> Modificar </a>
                            <a href="../../Funciones/eliminar.php"><i class="fa fa-fw fa-edit"></i> Eliminar </a>
