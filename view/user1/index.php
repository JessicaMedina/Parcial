        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">Acciones Permitidas</a>
                </div>
                <!-- Top Menu Items -->
                <ul class="nav navbar-right top-nav">
                    ...
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user"></i>  Usuario 1 <?php echo ucfirst($_SESSION['nombre']); ?> <b class="caret"></b></a>
...
<!--                                <li>
                                    <a href="../../Plato/CatalogoPlatos.php"></a>
                                </li>-->
                   
                            </ul>
                             <li>
                                 <a href="../../Plato/CatalogoPlatos.php"><i class="fa fa-fw fa-desktop"></i> Leer</a>
                            <a href="../../Funciones/agregarproducto.php"><i class="fa fa-fw fa-edit"></i> Agregar Plato</a>
                            <a href="../../Funciones/modificar.php"><i class="fa fa-fw fa-edit"></i> Modificar Plato</a>
                    </li>
