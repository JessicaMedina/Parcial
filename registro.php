          ...
          <div class="spacing-1"></div>
                       ...
                       <form id="formulario_registro">
                        ...
                        <fieldset>
                            ...
                            <legend class="center" style=" color: #0d8fe0; font-size: 30px; font-family: monospace ">REGISTRO</legend>
                            ...
                            <!-- Div espaciador -->
                            <div class="spacing-2"></div>
                            <!-- Caja de texto para seleccion -->
                            <label class="sr-only" for="user">Genero</label>
                            <div class="input-group">
                                <div class="input-group-addon"><i class="fa fa-user"></i></div>
                                <select type="text" class="form-control" name="genero" placeholder="Selecciona tu genero">

                                    <option value="a"> Selecciona</option>
                                    <option value="a"> Masculino</option>
                                    <option value="ac"> Femenino</option>
                                    <option value="act"> Otro</option>
